...
- **Sub-project B (Windows):** UIA MTA-worker adapter + WH_KEYBOARD_LL + layered overlay (PMv2). Default Vulkan+CPU build, optional CUDA. Strong tier = native toolkits; accept Electron-as-popup/hotkey. **(status 2026-09-09: not started beyond the fail-closed scaffold; "MTA-worker" here conflicts with the STA thread in the 2026-07-08 plan Phase 1.2 — decision pending, see §2. **Resolved 2026-09-17: MTA — see Qfd §23; "MTA-worker" is the decision of record.**)**
