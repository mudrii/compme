...
> **Last updated:** 2026-09-08 · **Branch:** `main` · v0.1.6 (tag `v0.1.6`) remains the latest published artifact · **Tests:** ≈2117 workspace tests listed on the current tree (44 spike tests separate)
>
