...
> **Last updated:** 2026-07-08 (review+tdd+ponytail pass + CI-gate hardening + doc-count sync) · **Branch:** `main` · **Tests:** full deterministic gates green on macOS (≈1791 workspace tests; spike separate)
>
