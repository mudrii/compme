...
> **Last updated:** 2026-09-16 · **Branch:** `main` · v0.1.6 (tag `v0.1.6`) remains the latest published artifact · **Tests:** ≈2160 workspace tests listed on the current tree (44 spike tests separate)
>
