...
> **Last updated:** 2026-07-07 (docs sync after release-pipeline audit + assisted-UI live evidence) · **Branch:** `main` · **Tests:** full deterministic gates green on macOS (≈1765 workspace tests; spike separate)
>
...
> review + tdd + ponytail pass (1765 tests, clippy clean). What remains for
