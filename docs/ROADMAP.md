...
| 30 | Per-platform performance baselines | Same-binary paired Linux medians: CPU 1,833 ms (fails), Vulkan 120 ms (passes unchanged 500 ms budget); three samples each on Quadro RTX 4000. [Measured evidence](PERFORMANCE-2026-09-19.md) records all samples and controls. CPU strategy and other target baselines remain open |
