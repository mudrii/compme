...
> **Last updated:** 2026-09-20 · **Branch:** `main` · v0.1.6 (tag `v0.1.6`) remains the latest published artifact · **Tests:** ≈2237 workspace tests (macOS inventory enforced by native CI; 44 spike tests separate)
>
